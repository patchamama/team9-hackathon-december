...
1. **Clone the repository to your local machine:**
   ...
   ```bash
   git clone https://github.com/patchamama/team9-hackathon-december.git
   ```
...
- **[Deployment](#deployment)**
  ...
  1. **Clone the Repository:**
     ...
     ```bash
     git clone https://patchamama.github.io/team9-hackathon-december.git
     cd team9-hackathon-december
     ```
